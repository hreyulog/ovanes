...
INPUT_PATH = os.path.join(PARENT_FOLDER,'src/data/raw/train.csv')
SUBMISSION_PATH = os.path.join(PARENT_FOLDER,'src/data/raw/submission_format.csv')
OUTPUT_PATH = os.path.join(PARENT_FOLDER,'src/data/processed/')
