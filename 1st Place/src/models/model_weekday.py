...
DATA_PATH = os.path.join(PARENT_FOLDER,'src/data/processed/')
INPUT_PATH = os.path.join(PARENT_FOLDER,'src/data/raw/')
RESULT_PATH = os.path.join(PARENT_FOLDER,'src/data/result/')
...
def read_data(path_name):
    ...
    '''
    dateparse = lambda date: datetime.strptime(date, "%Y-%m-%d %H:%M:%S")
